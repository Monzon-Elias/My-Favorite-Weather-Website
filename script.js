      ...
      ******************************/
      ...
      for (let i = 0; i < 4; i++) {
        ...
        if (dayNum <= 27 && monthNum == 1 || monthNum == 3 || monthNum == 5 || monthNum == 7 || monthNum == 8 || monthNum == 10 || monthNum == 12) {
          ...
          ++a;
         } else if (dayNum == 28 && monthNum == 1 || monthNum == 3 || monthNum == 5 || monthNum == 7 || monthNum == 8 || monthNum == 10 || monthNum == 12) {
           document.getElementsByClassName("dayNum")[3].innerHTML = 1;
         } else if (dayNum == 29 && monthNum == 1 || monthNum == 3 || monthNum == 5 || monthNum == 7 || monthNum == 8 || monthNum == 10 || monthNum == 12) {
           document.getElementsByClassName("dayNum")[2].innerHTML = 1;
           document.getElementsByClassName("dayNum")[3].innerHTML = 2;
         } else if (dayNum == 30 && monthNum == 1 || monthNum == 3 || monthNum == 5 || monthNum == 7 || monthNum == 8 || monthNum == 10 || monthNum == 12) {
         ...
         } else if (dayNum == 31 && monthNum == 1 || monthNum == 3 || monthNum == 5 || monthNum == 7 || monthNum == 8 || monthNum == 10 || monthNum == 12) {
          ...
          if (dayNum <= 26 && monthNum == 4 || monthNum == 6 || monthNum == 9 || monthNum == 11) {
            document.getElementsByClassName("dayNum")[i].innerHTML = dayNum + a;
            ++a;
          } else if (dayNum == 27 && monthNum == 4 || monthNum == 6 || monthNum == 9 || monthNum == 11) {
            document.getElementsByClassName("dayNum")[3].innerHTML = 1;
          } else if (dayNum == 28 && monthNum == 4 || monthNum == 6 || monthNum == 9 || monthNum == 11) {
            document.getElementsByClassName("dayNum")[2].innerHTML = 1;
            document.getElementsByClassName("dayNum")[3].innerHTML = 2;
          } else if (dayNum == 29 && monthNum == 4 || monthNum == 6 || monthNum == 9 || monthNum == 11) {
            document.getElementsByClassName("dayNum")[1].innerHTML = 1;
            document.getElementsByClassName("dayNum")[2].innerHTML = 2;
            document.getElementsByClassName("dayNum")[3].innerHTML = 3;
          ...
          //LEAP-YEAR
            ...
            document.getElementsByClassName("dayNum")[i].innerHTML = dayNum + a;
            ++a;
          } else if (dayNum == 26 && monthNum == 2 && dayNum <= 25) {
            document.getElementsByClassName("dayNum")[3].innerHTML = 1;
          } else if (dayNum == 27 && monthNum == 2 && dayNum <= 25) {
            document.getElementsByClassName("dayNum")[2].innerHTML = 1;
            document.getElementsByClassName("dayNum")[3].innerHTML = 2;
          } else if (dayNum == 28 && monthNum == 2 && dayNum <= 25) {
            document.getElementsByClassName("dayNum")[1].innerHTML = 1;
            document.getElementsByClassName("dayNum")[2].innerHTML = 2;
            document.getElementsByClassName("dayNum")[3].innerHTML = 3;
          } else if (dayNum == 29 && monthNum == 2 && dayNum <= 25) {
            document.getElementsByClassName("dayNum")[0].innerHTML = 1;
            document.getElementsByClassName("dayNum")[1].innerHTML = 2;
            document.getElementsByClassName("dayNum")[2].innerHTML = 3;
            document.getElementsByClassName("dayNum")[3].innerHTML = 4;
          ...
          //NORMAL FEBRURAY
            ...
            document.getElementsByClassName("dayNum")[i].innerHTML = dayNum + a;
            ++a;
          } else if (monthNum == 2 && dayNum == 25) {
            document.getElementsByClassName("dayNum")[3].innerHTML = 1;
          } else if (monthNum == 2 && dayNum == 26) {
            document.getElementsByClassName("dayNum")[2].innerHTML = 1;
            document.getElementsByClassName("dayNum")[3].innerHTML = 2;
          } else if (monthNum == 2 && dayNum == 27) {
            document.getElementsByClassName("dayNum")[1].innerHTML = 1;
            document.getElementsByClassName("dayNum")[2].innerHTML = 2;
            document.getElementsByClassName("dayNum")[3].innerHTML = 3;
